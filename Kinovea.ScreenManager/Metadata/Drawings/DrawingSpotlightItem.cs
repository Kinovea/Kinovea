...
namespace Kinovea.ScreenManager
{
    /// <summary>
    /// SpotLight item.
    /// Handles interaction and drawing of a single spotlight item.
    /// </summary>
    [XmlType ("Spotlight")]
    public class DrawingSpotlightItem : AbstractMultiDrawingItem, IKvaSerializable, ITrackable
    {
        #region Events
        ...
        public DrawingSpotlightItem(XmlReader xmlReader, PointF scale, TimestampMapper timestampMapper, Metadata metadata)
