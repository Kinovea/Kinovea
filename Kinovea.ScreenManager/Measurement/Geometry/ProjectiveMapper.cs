...
{
    /// <summary>
    /// Maps a quadrilateral in rectified image space to a quadrilateral in user defined plane.
    ...
    public class ProjectiveMapper
    {
        ...
        public ProjectiveMapper()
        {
            // TODO: initialize with identity.
        }
        ...
        public ProjectiveMapper(QuadrilateralF plane, QuadrilateralF image)
        {
            Update(plane, image);
        }
        ...
        /// <summary>
        /// Maps the world-space unit circle centered at the origin with radius 1, 
        /// to an ellipse in image space, using the internal homography matrix.
        /// Used to show the circle tool in perspective.
        /// </summary>
