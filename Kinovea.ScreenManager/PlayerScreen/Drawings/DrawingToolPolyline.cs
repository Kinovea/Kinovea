...
namespace Kinovea.ScreenManager
{
    public class DrawingToolPolyline : AbstractDrawingTool
    {
        ...
        {
            get { return Properties.Drawings.polyline2; }
        }
        ...
        {
            return new DrawingPolyline(origin, timestamp, averageTimeStampsPerFrame, stylePreset, transformer);
        }
