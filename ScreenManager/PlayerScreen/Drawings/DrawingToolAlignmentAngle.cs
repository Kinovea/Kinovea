...
{
    public class DrawingToolAlignmentAngle : AbstractDrawingTool
    {
    	
    	#region Properties
		public override string DisplayName
		{
			get { return "Alignment Angle"; /*ScreenManagerLang.ToolTip_DrawingToolAngle2D; */}
		}
		...
		#region Constructor
		public DrawingToolAlignmentAngle()
		{
		...
		{
            return new DrawingAlignmentAngle(_Origin, _iTimestamp, _AverageTimeStampsPerFrame, m_StylePreset);
		}
