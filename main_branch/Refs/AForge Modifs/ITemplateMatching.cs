...
namespace AForge.Imaging
{
    ...
    public interface ITemplateMatching
    {
        ...
        /// <summary>
        /// Process image looking for matchings with specified template within specified rectangle.
        /// </summary>
        /// 
        /// <param name="image">Source image to process.</param>
        ...
        /// <returns>Returns array of found matchings.</returns>
        /// 
        TemplateMatch[] ProcessImage(Bitmap image, Rectangle searchZone, Bitmap template);
        ...
        /// <returns>Returns array of found matchings.</returns>
        /// 
        TemplateMatch[] ProcessImage(BitmapData imageData, Rectangle searchZone, BitmapData templateData);
    }
}
