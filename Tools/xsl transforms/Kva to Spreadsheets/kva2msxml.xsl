...
<!-- 
	...
	2. Add <?xml-stylesheet type="text/xsl" href="kva2msxml.xsl"?> in the .kva (now .xml) file at second line, just before <KinoveaVideoAnalysis>.
	...
	<Workbook>
      ...
      <Style ss:ID="s25">
		...
		<Worksheet>
			...
			<Table ss:ExpandedColumnCount="2" ss:ExpandedRowCount="112" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="60">
...
<xsl:template match="Keyframes">
	...
	<Row>
		<Cell ss:StyleID="s21"><Data ss:Type="String">Images clés</Data></Cell>
	</Row>
	<xsl:for-each select="Keyframe">
		<Row>
			<Cell ss:StyleID="s24"><Data ss:Type="String">Titre :</Data></Cell>
			<Cell ss:StyleID="s24"><Data ss:Type="String"><xsl:value-of select="Title"/></Data></Cell>
		</Row>
	</xsl:for-each>
</xsl:template>
...
<xsl:template match="Tracks">
	...
	<xsl:for-each select="Track">
		...
		<!-- Track table -->
		<Row>
			<Cell ss:StyleID="s22"><Data ss:Type="String">Trajectoire</Data></Cell>
		</Row>
		<Row>
			<Cell ss:StyleID="s24"><Data ss:Type="String">Label :</Data></Cell>
			<Cell ss:StyleID="s24"><Data ss:Type="String"><xsl:value-of select="Label/Text"/></Data></Cell>
		</Row>
		<Row>
			<Cell ss:StyleID="s24"><Data ss:Type="String">Coordonnées (pixels)</Data></Cell>
		</Row>
		<Row>
			<Cell ss:StyleID="s25"><Data ss:Type="String">x</Data></Cell>
			<Cell ss:StyleID="s25"><Data ss:Type="String">y</Data></Cell>
		</Row>
...
<xsl:template match="Chronos">
	...
	<xsl:for-each select="Chrono">
		...
		<!-- Chrono table -->
		<Row>
			<Cell ss:StyleID="s23"><Data ss:Type="String">Chrono</Data></Cell>
		</Row>
		<Row>
			<Cell ss:StyleID="s24"><Data ss:Type="String">Label :</Data></Cell>
			<Cell ss:StyleID="s24"><Data ss:Type="String"><xsl:value-of select="Label/Text"/></Data></Cell>
		...
		<Row>
			<Cell ss:StyleID="s24"><Data ss:Type="String">Durée (ts)</Data></Cell>
			<Cell ss:StyleID="s24"><Data ss:Type="Number"><xsl:value-of select="Values/StopCounting - Values/StartCounting"/></Data></Cell>
		</Row>	
	</xsl:for-each>
